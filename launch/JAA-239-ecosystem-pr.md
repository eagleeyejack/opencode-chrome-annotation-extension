...
>
> The agent side is an npm plugin (`opencode-chrome-annotation`, fork published as `@eagleeyejack/opencode-chrome-annotation`); the extension is GPL-3.0 and a credited fork of JodusNodus/opencode-chrome-annotation, rebuilt around a Chrome side panel. Not affiliated with the OpenCode team (note included in the READMEs).
>
